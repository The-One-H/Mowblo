...
const ToSPage = () => {
  return (
    <SafeAreaView className="flex-1 justify-center items-center bg-gray-100 p-5">
        {/* Legal agreement */}
        <Text className='text-3xl'>Terms of Service Agreement v0.0.-1</Text>
        <Text className="text-center text-2xl font-bold text-gray-800 mb-5">Bla bla bla... You agree to sign away your life... Bla bla bla</Text>
